...
function classLoader($class) {
    ...
    if(file_exists(app::moduleRoot().'Component/'.$classPath)){
        require_once app::moduleRoot().'Component/'.$classPath;
        return;
    }
    if(file_exists(app::moduleRoot().'Controller/'.$classPath)){
        require_once app::moduleRoot().'Controller/'.$classPath;
        return;
    }
    if(file_exists(app::moduleRoot().$classPath)){
        require_once app::moduleRoot().$classPath;
        return;
    }
    if(file_exists(app::srcRoot().'Component/'.$classPath)){
        require_once app::srcRoot().'Component/'.$classPath;
        return;
    }
    if(file_exists(app::srcRoot().'Controller/'.$classPath)){
        require_once app::srcRoot().'Controller/'.$classPath;
        return;
    }
    if(file_exists(app::srcRoot().$classPath)){
        require_once app::srcRoot().$classPath;
        return;
    }
